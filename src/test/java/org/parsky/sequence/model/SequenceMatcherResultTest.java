...
public class SequenceMatcherResultTest {
    ...
    public void withJump() throws Exception {
        ...
        SequenceMatcherResult underTest = new SequenceMatcherResult(type, 0, matchResultOptional, Optional.<ErrorResult>absent());
    ...
    public void isMatch() throws Exception {
        ...
        assertFalse(new SequenceMatcherResult(SequenceMatcherResultType.ERROR, 0, Optional.<MatchResult>absent(), Optional.<ErrorResult>absent()).matched());
        assertFalse(new SequenceMatcherResult(SequenceMatcherResultType.MISMATCH, 0, Optional.<MatchResult>absent(), Optional.<ErrorResult>absent()).matched());
    }

    @Test
    public void isMismatch() throws Exception {
        assertTrue(SequenceMatcherResult.mismatch().isMismatch());
        assertFalse(new SequenceMatcherResult(SequenceMatcherResultType.ERROR, 0, Optional.<MatchResult>absent(), Optional.<ErrorResult>absent()).isMismatch());
        assertFalse(new SequenceMatcherResult(SequenceMatcherResultType.MATCHED, 0, Optional.<MatchResult>absent(), Optional.<ErrorResult>absent()).isMismatch());
    }
}