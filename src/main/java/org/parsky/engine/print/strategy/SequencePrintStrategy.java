...
public class SequencePrintStrategy implements PrintStrategy<SequenceRule> {
    private final PrintStrategy printStrategy;

    public SequencePrintStrategy(PrintStrategy printStrategy) {
        this.printStrategy = printStrategy;
    }

    @Override
    public PrintNode print(SequenceRule rule, final PrintQueue queue) {
